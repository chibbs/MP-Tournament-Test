	...
	public static void main(String[] args) {
		...
		try {
			...
			try {
				...
				List<TournamentType> ttlist = em
						.createQuery("select tt from TournamentType as tt", TournamentType.class).getResultList();
				System.out.println(ttlist.size());

				List<Tournament> tlist = em.createQuery("select t from Tournament as t", Tournament.class)
						.getResultList();
				...
				List<Competitor> clist = em.createQuery("select c from Competitor as c", Competitor.class)
						.getResultList();
